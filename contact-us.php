...
<html lang="en">
    <head>
        ...
        <title>Technomac - Contact Us</title>
        ...
        <script>window.gtranslateSettings = {"default_language":"en","native_language_names":true,"detect_browser_language":true,"languages":["en","fr","pt","ru"],"wrapper_selector":".gtranslate_wrapper","switcher_horizontal_position":"right"}</script>
                    ...
                    <div class="contact-page-box">
                        <div class="uk-grid" data-uk-grid>
                            <div class="uk-width-1-3@m">
                                <div class="contact-page-sidebar"><a class="footer-logo" href="/"><img src="assets/img/logo-white.png" alt="image"></a>
                        ...
                        <div class="page-footer__inner">
                            ...
                            <div class="page-footer__menu">
                                ...
                                <ul class="uk-nav">
                                    ...
                                    <li><a href="#">Used Equipment Sale</a></li>
                                </ul>
                            </div>
